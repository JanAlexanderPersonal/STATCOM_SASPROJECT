...
ods printer file="&path/MeanTemperature.png";
...
options printerpath=png nodate papersize=('5in','4in');
ods printer file="&path/DifferenceCounty_CountyCodes.png";
...
ods printer file="&path/Mean03_table.png";
...
options printerpath=png nodate papersize=('10in','11in');
ods printer file="&path/Vbarplot_MeanO3.png";	
